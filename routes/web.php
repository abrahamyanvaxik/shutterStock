...
use App\Http\Livewire\StartTaskComponent;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['authorization'])->group(function () {
        ...
        Route::get('tasks', IndexTaskComponent::class)->name('tasks.index');
        Route::get('tasks/create', CreateTaskComponent::class)->name('tasks.create');
        Route::get('tasks/{task}/show', ShowTaskComponent::class)->name('tasks.show');
        Route::get('tasks/{task}/edit', EditTaskComponent::class)->name('tasks.edit');

        Route::get('tasks/{task}/start', StartTaskComponent::class)->name('tasks.start');
    });
});
